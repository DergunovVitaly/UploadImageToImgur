...
struct R: Rswift.Validatable {
  ...
  struct string {
    ...
    struct localizable {
      ...
      static let connectToTheInternet = Rswift.StringResource(key: "connectToTheInternet", tableName: "Localizable", bundle: R.hostingBundle, locales: [], comment: nil)
      ...
      /// Value: Please, connect to the Internet
      static func connectToTheInternet(preferredLanguages: [String]? = nil) -> String {
        guard let preferredLanguages = preferredLanguages else {
          return NSLocalizedString("connectToTheInternet", bundle: hostingBundle, comment: "")
        }

        guard let (_, bundle) = localeBundle(tableName: "Localizable", preferredLanguages: preferredLanguages) else {
          return "connectToTheInternet"
        }

        return NSLocalizedString("connectToTheInternet", bundle: bundle, comment: "")
      }
